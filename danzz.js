...
Selama ${clockString(new Date - user.afkTime)}`)
		...
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": `Nothing>_`, "caption": `Nothing>_`, 'jpegThumbnail': await reSize(thumb, 100, 100)}}}
		const fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {}) },message: { "videoMessage": { "title":`Nothing>_`, "h": `Hmm`,'seconds': '359996400', 'caption': `Nothing`, 'jpegThumbnail': await reSize(thumb, 100, 100)}}}
...
https://danzzapi.xyz (danzz)`
      	  let buttons = [
                ...
                let buttonMessage = {
                    image: { url: 'https://telegra.ph/file/e8dc0c3f102646f88d7be.jpg' },
                    caption: `${tqto}`,
                    footer: `${tag}\n\n${global.wm}`,
                    buttons: buttons,
                    headerType: 4
...
Bot : Buy Sc Bot Nothing>_ bisa chat owner dengan ketik #owner
...
Ini`
      	  let buttons = [
                ...
                let buttonMessage = {
                    image: { url: 'https://telegra.ph/file/e2d4b7fc310730bbc0802.jpg' },
                    caption: `${rules}`,
                    footer: `${rulesnya}\n\n${global.wm}`,
                    buttons: buttons,
                    headerType: 4
...
let donate = `
Halo👋 Terima Kasih Yang Sudah Berdonasi! Akan Sangat Membantu Owner Untuk Membeli Kebutuhan Run Bot Seperti Panel/Rdp/Vps!

*e-wallet*
Gopay: 088242224080 (Atau Scan Barcode Diatas)`
let buttons = [
                    {buttonId: `rules`, buttonText: {displayText: 'Rules'}, type: 1},
                    {buttonId: `menu`, buttonText: {displayText: 'Menu'}, type: 1},
                    {buttonId: `owner`, buttonText: {displayText: 'Owner'}, type: 1}
                ...
                let buttonMessage = {
                    image: { url: 'https://telegra.ph/file/d5da51a774cf359071f9c.jpg' },
                    caption: `${payment}`,
                    footer: `${donate}\n\n${global.wm}`,
                    buttons: buttons,
                    headerType: 4
...
break
		...
		if (!isPremium) throw mess.premium
            ...
            var m3 = mon.split("|")[2]
               ...
               let ivg = `https://telegra.ph/file/b4fe024fb294d0982079a.jpg`
